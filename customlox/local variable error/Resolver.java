...
//> scopes-field
  //CH10, Q3: changed "boolean" to "Variable"
...
//> Inheritance begin-super-scope
    ...
    if (stmt.superclass != null) {
      ...
      //CH11, Q3 START - not in answers section
      scopes.peek().put(
        "super",
        new Variable(
      ...
      //CH11, Q3 END - not in answers section
    }
//< Inheritance begin-super-scope
//> resolve-methods
