...
//MY CODE START
static int constantInstructionLong(const char* name, Chunk* chunk,
                               int offset) {
  uint32_t index = {
...
//> disassemble-constant
    ...
    case OP_CONSTANT_LONG: //MY CODE
      return constantInstructionLong("OP_CONSTANT_LONG", chunk, offset); //MY CODE
//< disassemble-constant
